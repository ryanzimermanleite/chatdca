...
def home():
    ...
    if request.method == "POST":
        ...
        if join != False and not code:
            return render_template("home.html", error="Por favor digite o codigo da sala.", code=code, name=name)
        ...
        if create != False:
            ...
            return render_template("home.html", error="Sala não existe.", code=code, name=name)
...
def connect(auth):
    ...
    print(f"{name} sala ingressada {room}")
